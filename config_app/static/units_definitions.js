document.addEventListener('DOMContentLoaded', function() {
    fetch('https://config-app-demo-templatemodelrunner-dev.demo.quix.io/get_units')
...
document.getElementById('unitsForm').addEventListener('submit', function(event) {
    ...
    fetch('https://config-app-demo-templatemodelrunner-dev.demo.quix.io/publish_units', {
        method: 'POST',
        headers: {
